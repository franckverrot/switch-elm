...
var _user$project$Models_Box$Inactive = {ctor: 'Inactive'};
...
var _user$project$GameEvent$Tick = function (a) {
...
var _user$project$Update$activateBox = F3(
	function (position, time, boxes) {
		return function (box) {
			...
			A2(_user$project$Update$boxAt, position, boxes));
	});
			...
			case 'PickAgain':
				return A2(
					...
					model,
					{
						...
						_0: A2(
							_elm_lang$core$Random$generate,
							_user$project$GameEvent$ActivateBox,
							A2(
			...
			case 'ActivateBox':
				...
				var events = function () {
					...
					if (_p3.ctor === 'Nothing') {
						return {
							ctor: '::',
							_0: A2(_elm_lang$core$Task$perform, _user$project$GameEvent$PickAgain, _elm_lang$core$Time$now),
							_1: {ctor: '[]'}
						};
					} else {
						return {ctor: '[]'};
			...
			case 'Tick':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							boxes: A2(_elm_lang$core$Array$map, _user$project$Update$tickBox, model.boxes)
						}),
					{
						ctor: '::',
						_0: A2(
...
var _user$project$View$view = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$id(_user$project$CssTypes$Page),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$h1,
				{
					...
					_0: _user$project$View$class(
						{
							ctor: '::',
							_0: _user$project$CssTypes$Header,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Switch in Elm'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://github.com/franckverrot/switch-elm'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
